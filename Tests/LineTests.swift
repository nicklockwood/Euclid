...
class LineTests: XCTestCase {
    ...
    func testLineIntersectionXY() {
        let l1 = Line(unchecked: Vector(1, 0, 3), direction: .unitX)
        let l2 = Line(unchecked: Vector(0, 1, 3), direction: -.unitY)
    ...
    func testLineIntersectionXZ() {
        let l1 = Line(unchecked: Vector(1, 3, 0), direction: .unitX)
        let l2 = Line(unchecked: Vector(0, 3, 1), direction: -.unitZ)
    ...
    func testLineIntersectionYZ() {
        let l1 = Line(unchecked: Vector(3, 1, 0), direction: .unitY)
        let l2 = Line(unchecked: Vector(3, 0, 1), direction: -.unitZ)
    ...
    func testEquivalentHorizontalLinesAreEqual() {
        let l1 = Line(origin: Vector(1, -1, 0), direction: .unitX)
        let l2 = Line(origin: Vector(3, -1, 0), direction: .unitX)
        XCTAssertEqual(l1, l2)
        XCTAssert(Set([l1]).contains(l2))
    }

    func testEquivalentVerticalLinesAreEqual() {
        let l1 = Line(origin: Vector(2, 5, 0), direction: .unitY)
        let l2 = Line(origin: Vector(2, -1, 0), direction: .unitY)
        XCTAssertEqual(l1, l2)
        XCTAssert(Set([l1]).contains(l2))
    }

    func testEquivalentZLinesAreEqual() {
        let l1 = Line(origin: Vector(2, 5, -2), direction: -.unitZ)
        let l2 = Line(origin: Vector(2, 5, 7), direction: -.unitZ)
        XCTAssertEqual(l1, l2)
        XCTAssert(Set([l1]).contains(l2))
    }
