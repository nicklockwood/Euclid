...
extension AngleTests {
    ...
    static let __allTests__AngleTests = [
        ...
        ("testAtan", testAtan),
        ("testAtan2FirstQuadrant", testAtan2FirstQuadrant),
        ("testAtan2FourthQuadrant", testAtan2FourthQuadrant),
        ("testAtan2SecondQuadrant", testAtan2SecondQuadrant),
        ("testAtan2ThirdQuadrant", testAtan2ThirdQuadrant),
